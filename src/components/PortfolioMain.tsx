...
const PortfolioMain = () => {
  ...
  return (
    <section id="intro">
      ...
      <div className="App relative min-h-screen transition-opacity duration-1000 ease-in px-6 sm:px-40 md:px-60 pt-20 bg-gradient-to-br from-background-dark-primary via-background-dark-secondary to-background-dark-tertiary text-gray-200">
        <section id="intro">
