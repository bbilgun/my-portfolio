...
import avatar from "../assets/images/final_avatar.png";
...
const PortfolioMain = () => {
  ...
  return (
    <section id="intro">
      ...
      <div
        className={`App relative min-h-screen text-gray-800 transition-opacity duration-1000 ease-in px-6 sm:px-40 md:px-60 pt-20 ${
          fadeIn ? "opacity-100" : "opacity-0"
        } bg-gradient-to-br from-black via-[#0a0a0a] to-[#0c001b]`}
      >
        <CanvasCursor />
        {/* Main Section */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 py-16 scale-[1.25] px-6 sm:px-12 md:px-20 lg:px-28 pt-48">
          ...
          >
            <div className="flex flex-col gap-4 max-w-xl text-left items-start">
              <span className="bg-purple-900 text-white px-2 py-1 rounded text-sm">
                My name is
              </span>
              <h1 className="text-4xl sm:text-5xl font-bold leading-tight text-gray-200">
                Bilguun A.
              </h1>
              <h2 className="uppercase text-gray-400 tracking-wider text-sm font-semibold">
                Member of Sys&CoTech club
              </h2>
          ...
          >
            <img
              src={avatar}
              alt="bilguun avatar"
              className="w-[180px] sm:w-[220px] md:w-[280px] lg:w-[340px] rounded-full border-4 border-purple-800 shadow-lg hover:shadow-purple-500/40 transition duration-500"
            />
          </div>
        </div>
        {/* Social Icons */}
